...
//  ECommerceShop (iOS)
//
//  Created by Emanuel Jorge on 06/12/21.
//
...
struct SearchView: View {
   ...
   @FocusState var startTF: Bool
    ...
    var body: some View {
        ...
        VStack(spacing: 0){
            ...
            HStack(spacing: 20){
                ...
                .background(
                    ...
                    Capsule()
                        .strokeBorder(Color("Purple"), lineWidth: 1.5) // MARK: - Definir Cor no Assets
                )
        ...
        .background(
            Color("HomeBG").ignoresSafeArea() // MARK: - Definir Cor no Assets
        )
        .onAppear {
